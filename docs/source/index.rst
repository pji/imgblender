.. imgblender documentation master file, created by
   sphinx-quickstart on Sun Oct  8 06:51:41 2023.
   You can adapt this file completely to your liking, but it should at least
   contain the root `toctree` directive.

imgblender Documentation
========================
...
=======================================
Yes, but :mod:`imgblender` is not currently available through PyPI. You
will need to clone the repository to the system you want to install
:mod:`imgblender` on and run the following::
